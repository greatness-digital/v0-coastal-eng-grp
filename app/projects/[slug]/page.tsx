...
export default function ProjectDetailPage() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        // Make slug available to the JSX layer before it runs
        ;(window as any).__CEG_SLUG = slug
    ...
    <>
      {error && (
        <div role="alert" style={{ padding: 24, margin: 24, border: "1px solid #b00020",
          ...
          <strong>Failed to mount project page:</strong> {error}
        </div>
      )}
      <div id="root" />
    </>
